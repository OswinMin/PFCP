...
if __name__ == '__main__':
    ...
    Rpath = f"../Result/Aux_cos/{d}_{n}_{agentN}_{gammaSelectRule}_{g}"
    Lpath = f"../Log/Aux_cos/{d}_{n}_{agentN}_{gammaSelectRule}_{g}.txt"
    checkDir("../Result")
    checkDir("../Result/Aux_cos")
    checkDir(Rpath)
    checkDir("../Log")
    checkDir("../Log/Aux_cos")
