...
if __name__ == '__main__':
    if os.path.split(os.getcwd())[1] != 'Test_Aux':
        os.chdir(os.path.join(os.getcwd(), 'Test_Aux'))
    ...
    Rpath = f"../Result/Aux_abs/{d}_{n}_{agentN}_{gammaSelectRule}_{g}"
    Lpath = f"../Log/Aux_abs/{d}_{n}_{agentN}_{gammaSelectRule}_{g}.txt"
    checkDir("../Result")
    checkDir("../Result/Aux_abs")
    checkDir(Rpath)
    checkDir("../Log")
    checkDir("../Log/Aux_abs")
