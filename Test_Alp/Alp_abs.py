...
if __name__ == '__main__':
    ...
    Rpath = f"../Result/Alp_abs/{d}_{n}_{agentN}_{gammaSelectRule}_{g}"
    Lpath = f"../Log/Alp_abs/{d}_{n}_{agentN}_{gammaSelectRule}_{g}.txt"
    checkDir("../Result")
    checkDir("../Result/Alp_abs")
    checkDir("../Log")
    checkDir("../Log/Alp_abs")
