...
if __name__ == '__main__':
    ...
    Rpath = f"../Result/Sele_abs/{d}_{n}_{agentN}_{seleagentN}_{cor_ratio}"
    Lpath = f"../Log/Sele_abs/{d}_{n}_{agentN}_{seleagentN}_{cor_ratio}.txt"
    checkDir("../Result")
    checkDir("../Result/Sele_abs")
    checkDir(Rpath)
    checkDir("../Log")
    checkDir("../Log/Sele_abs")
